...
class FollowingViewModel : ViewModel() {
    ...
    val listFollowingViewModel = MutableLiveData<ArrayList<User>>()
    private val apiKey = BuildConfig.GITHUB_TOKEN

    fun setFollowing(loginName: String) {
        val list = ArrayList<User>()
        val client = AsyncHttpClient()
        val url = "https://api.github.com/users/$loginName/following"
        ...
        client.get(url, object : AsyncHttpResponseHandler() {
            override fun onSuccess(
                ...
                try {
                    ...
                    listFollowingViewModel.postValue(list)
